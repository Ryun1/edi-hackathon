...
export const METHOD = {
  ...
  submitDRepRegistrationCertificate: 'submitDRepRegistrationCertificate',
  submitDRepRetirementCertificate: 'submitDRepRetirementCertificate',
  submitVote: 'submitVote',
  submitGovernanceAction: 'submitGovernanceAction',
};
